...
export default function UpdateBoxPage({ params }: { params: { id: string } }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await updateDoc(doc(db, 'boxes', params.id), {
        ...formData,
        imageUrl,
      })
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <Card className="w-full max-w-2xl mx-auto">
        <CardHeader>
          <CardTitle>Update Box</CardTitle>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <Select name="articleType" value={formData.articleType} onValueChange={(value: ArticleType) => setFormData((prev) => ({ ...prev, articleType: value }))}>
                <SelectTrigger>
